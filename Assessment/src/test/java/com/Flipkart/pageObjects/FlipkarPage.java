...
public class FlipkarPage {
	...
	public boolean FirstItem_is_Displayed()
	{
	...
	public boolean Price_Sorted()
	{
		WebElement FirstItem= driver.findElement(Highlighted_Low_to_high_Sort);
		boolean isdisplayed = FirstItem.isDisplayed();
		return isdisplayed;
		
	}
	
	public boolean First_Item_name_isDisplayed()
	{
		WebElement FirstItem= driver.findElement(First_Item_name);
		boolean isdisplayed = FirstItem.isDisplayed();
		return isdisplayed;
		
	}
	
	public boolean First_Item_price_isDisplayed()
	{
		WebElement FirstItem= driver.findElement(First_Item_price);
		boolean isdisplayed = FirstItem.isDisplayed();
		return isdisplayed;
		
	}
	
	public boolean cart_Item_name_isDisplayed()
	{
		WebElement FirstItem= driver.findElement(cart_Item_name);
		boolean isdisplayed = FirstItem.isDisplayed();
		return isdisplayed;
